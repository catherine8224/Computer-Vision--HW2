...
# Horizontal = np.concatenate((resized_img, resized_img2, addition, log_add), axis=1)
# Horizontal2 = np.concatenate((subtraction, division, multiplication), axis=1)

#Logarithmic image Processing
# Horizontal3 = np.concatenate((log_add, log_sub, scalar_mult), axis=1)
# H = np.concatenate((Horizontal, Horizontal2, Horizontal3), axis=0)
cv2.imshow('Algebraic Image Processing', H)
cv2.waitKey(0)
